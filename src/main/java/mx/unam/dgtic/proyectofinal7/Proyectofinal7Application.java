package mx.unam.dgtic.proyectofinal7;
...
public class Proyectofinal7Application {

	public static void main(String[] args) {
		SpringApplication.run(Proyectofinal7Application.class, args);
	}
	@Bean
	public DataSource dataSource() {
		...
		dataSource.setUrl("jdbc:mariadb://192.168.0.5:3307/proyecto_final");
