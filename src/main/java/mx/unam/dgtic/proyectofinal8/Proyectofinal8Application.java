...
public class Proyectofinal8Application {

	public static void main(String[] args) {
		SpringApplication.run(Proyectofinal8Application.class, args);
	}
	...
	public DataSource dataSource() {
		...
		dataSource.setUrl("jdbc:mariadb://192.168.0.3:3307/proyecto_final");
	...
	LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
		...
		entityManagerFactoryBean.setPackagesToScan("mx.unam.dgtic.proyectofinal8");
